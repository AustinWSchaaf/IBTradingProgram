...
interface EWrapperDelegate{
    void priceChange(int tickerId, int field, double price);
    void sizeChange(int tickerId, int field, int size, Date date);
    void filledPrice(double price);
    void fiveSecBar(double high, double low, double close, Date date);
    void tradePrice(Double price, int size);
}
public class EWrapperImpl implements EWrapper{
    ...
    private EWrapperDelegate delegate;
...
//    private static MarketMaking market = new MarketMaking();
    
	//! [socket_declare]

    //! [socket_init]
    public EWrapperImpl(EWrapperDelegate delegate) {
...
//        }
        ...
        delegate.priceChange(tickerId, field, price);
...
//            market.add(bidPrice, size, "BID");
//        }else if (field == 3){
//            market.add(askPrice, size, "ASK");
////            System.out.println("Ask size= " + size);
//        }else if (field == 5){
////            System.out.println("Volume = " + size);
//        }
        if (field == 5){
            System.out.println("Traded Price: " + tradedPrice + " Size: " + size);
            delegate.tradePrice(tradedPrice,size);
        }
        
        delegate.sizeChange(tickerId, field, size, date);
    }
	//! [ticksize]
...
//                + ", ClientId: " + clientId + ", WhyHeld: " + whyHeld + ", MktCapPrice: " + mktCapPrice);
        ...
        delegate.filledPrice(lastFillPrice);
    ...
    public void realtimeBar(int reqId, long time, double open, double high, double low, double close, long volume, double wap, int count) {
        ...
        delegate.fiveSecBar(high, low, close, date);
        System.out.println("RealTimeBars. " + reqId + " - Time: " + date + ", Open: " + open + ", High: " + high + ", Low: " + low + ", Close: " + close + ", Volume: " + volume + ", Count: " + count + ", WAP: " + wap);
    }
